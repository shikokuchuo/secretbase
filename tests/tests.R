...
test_true(abs(cbordec(as.raw(c(0xfa, 0x7f, 0x7f, 0xff, 0xff))) - 3.4028235e+38) < 1e+31)
test_identical(cbordec(as.raw(c(0xfb, 0x3f, 0xf1, 0x99, 0x99, 0x99, 0x99, 0x99, 0x9a))), 1.1)
test_true(abs(cbordec(as.raw(c(0xfb, 0x7e, 0x37, 0xe4, 0x3c, 0x88, 0x00, 0x75, 0x9c))) / 1e300 - 1) < 1e-15)
