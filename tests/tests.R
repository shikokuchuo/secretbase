...
# JSON tests:
test_type("list", jsondec('{"key":"value"}'))
...
test_identical(jsondec('[1,2,3]'), list())
...
test_equal(jsondec('{"nested":{"a":1}}')[["nested"]][["a"]], 1)
test_equal(jsondec('{"deep":{"level1":{"level2":3}}}')[["deep"]][["level1"]][["level2"]], 3)
test_type("list", jsondec('{"arr":[1,2,3]}')[["arr"]])
test_equal(length(jsondec('{"arr":[1,2,3]}')[["arr"]]), 3)
test_equal(jsondec('{"arr":[1,2,3]}')[["arr"]][[2]], 2)
test_equal(jsondec('{"mixed":["text",123,true,null]}')[["mixed"]][[1]], "text")
test_equal(jsondec('{"mixed":["text",123,true,null]}')[["mixed"]][[2]], 123)
test_true(jsondec('{"mixed":["text",123,true,null]}')[["mixed"]][[3]])
test_null(jsondec('{"mixed":["text",123,true,null]}')[["mixed"]][[4]])
test_equal(length(jsondec('{"empty":[]}')[["empty"]]), 0)
test_equal(jsondec('{"objects":[{"id":1},{"id":2}]}')[["objects"]][[1]][["id"]], 1)
...
test_equal(jsondec(as.raw(c(0x7b, 0x22, 0x70, 0x22, 0x3a, 0x22, 0x63, 0x3a, 0x5c, 0x5c, 0x64, 0x22, 0x7d)))[["p"]], "c:\\d")
test_identical(jsondec('  {  "key"  :  "value"  }  ')[["key"]], "value")
