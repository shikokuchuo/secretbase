...
`FALSE` - raw vector - `NA` - integer vector (for hashes with SHAKE256)
or unserialized object (for base64/base58 decoding)
...
equality - `test_identical()` - Assert identical (stricter than equal) -
...
Base58Check tests use known Bitcoin test vectors.
