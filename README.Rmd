...
Base 64 encoding and decoding of strings, raw vectors and serialized objects.
...
Base64 encoding and decoding implementations are based on those by the 'Mbed TLS' Trusted Firmware Project at <https://www.trustedfirmware.org/projects/mbed-tls>.
